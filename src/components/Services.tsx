...
const services = [
  ...
  },
  {
    ...
    title: "Büroreinigung",
    desc: "Saubere Büroräume und hygienische Arbeitsplätze für einen professionellen Eindruck bei Kunden und Mitarbeitern.",
    bullets: [
      "Büro- & Gewerbeflächen",
      "Arbeitsplätze & Böden",
  ...
  {
    img: windowImg,
    eyebrow: "04 — Glasreinigung",
    title: "Glasreinigung",
    desc: "Streifenfreie Reinigung von Glasflächen, Fenstern und Fassaden - für maximale Transparenz und einen perfekten ersten Eindruck.",
    bullets: [
      "Glasflächen & Fassaden",
      "Innen- & Außenreinigung",
      "Osmose- & Teleskoptechnik",
  ...
  },
  {
    ...
    desc: "Intensive Tiefenreinigung für stark beanspruchte Böden, Flächen und Räume - gründlich, hygienisch und professionell ausgeführt.",
    bullets: [
  ...
  {
    img: garden,
    eyebrow: "06 — Garten & Pflege",
    title: "Garten & Pflege",
    desc: "Gepflegte Außenanlagen schaffen einen positiven Eindruck und erhöhen den Wert Ihrer Immobilie. Wir übernehmen die regelmäßige Pflege - zuverlässig, professionell und mit Liebe zum Detail.",
    bullets: [
      "Rasen mähen",
      "Unkrautentfernung",
